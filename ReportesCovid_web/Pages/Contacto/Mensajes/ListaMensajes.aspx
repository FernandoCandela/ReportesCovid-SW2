<%@ Page Title="Contacto" Language="C#" MasterPageFile="~/MasterPages/Web_Contacto.Master" AutoEventWireup="true" CodeBehind="ListaMensajes.aspx.cs" Inherits="ReportesCovid_web.Pages.Contacto.ListaMensajes" %>
                                ...
                                <div class="table-responsive mx-5">
                                    <div class="table table-striped table-sm table-primary">
                                        <asp:GridView runat="server" ID="gvMensajes" AutoGenerateColumns="False" AllowPaging="True"
                                            CssClass="table" PageSize="5" OnRowDataBound="gvMensajes_RowDataBound" OnPageIndexChanging="gvMensajes_PageIndexChanging"
